...
export default class StackTransitioner extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    const routeAnimationType =
      action === PUSH ? (children.props.animationType || (children.props.location.state && children.props.location.state.animationType))
      :
      (previousChildren.props.animationType || (previousChildren.props.location.state && previousChildren.props.location.state.animationType));
